...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        trader_data = trader_data +state.traderData
        logger.print('trader_data:', trader_data)
        ...
        for product in state.order_depths:
            ...
            orders: List[Order] = []
            acceptable_price = 10 #edit this
            logger.print("acceptable_price: ", acceptable_price)
